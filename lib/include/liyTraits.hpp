...
template <>
struct isIntegral<signed char> : public trueType {};
template <>
struct isIntegral<unsigned char> : public trueType {};
template <>
struct isIntegral<wchar_t> : public trueType {};
template <>
struct isIntegral<char16_t> : public trueType {};
template <>
struct isIntegral<char32_t> : public trueType {};
template <>
...
template <>
struct isFloatingPoint<float> : public trueType {};
template <>
struct isFloatingPoint<double> : public trueType {};
...
template <typename Ty>
struct isEnum {
    static constexpr bool value = !isClass<Ty>::value && !isIntegral<Ty>::value && !isFloatingPoint<Ty>::value &&
                                  !isVoid<Ty>::value && !isNullptr<Ty>::value;
};
/* 只有函数类型和引用类型不能被const修饰 */
template <typename T>
...
template <typename Ty>
struct isScalar
    : public boolWrapper<isArithmetic<Ty>::value || isEnum<Ty>::value || isPointer<Ty>::value || isNullptr<Ty>::value> {
};
...
template <typename Ty>
struct removeVolatile<volatile Ty> {
    using type = Ty;
};
template <typename Ty>
...
template <typename Ty>
struct removeCV {
    using type = removeVolatile_t<removeConst_t<Ty>>;
};
template <typename Ty>
...
template <typename Ty>
struct removePointer<Ty *> {
    using type = Ty;
};
template <typename Ty>
struct removePointer<Ty *const> {
    using type = Ty;
};
template <typename Ty>
struct removePointer<Ty *volatile> {
    using type = Ty;
};
template <typename Ty>
struct removePointer<Ty *const volatile> {
    using type = Ty;
};
template <typename Ty>
...
template <typename Ty>
struct removeAllPointers<Ty *> {
    using type = typename removeAllPointers<Ty>::type;
};
template <typename Ty>
...
template <typename Ty>
struct addPointer {
    using type = removeReference_t<Ty> *;
};
template <typename Ty>
...
template <typename Ty>
inline constexpr bool isVoid_v = isVoid<Ty>::value;
template <typename Ty>
inline constexpr bool isIntegral_v = isIntegral<Ty>::value;
template <typename Ty>
inline constexpr bool isFloat_v = isFloat<Ty>::value;
template <typename Ty>
inline constexpr bool isDouble_v = isDouble<Ty>::value;
template <typename Ty>
inline constexpr bool isFloatingPoint_v = isFloatingPoint<Ty>::value;
template <typename Ty>
inline constexpr bool isArithmetic_v = isArithmetic<Ty>::value;
template <typename Ty>
inline constexpr bool isSigned_v = isSigned<Ty>::value;
template <typename Ty>
inline constexpr bool isUnsigned_v = isUnsigned<Ty>::value;
template <typename Ty>
inline constexpr bool isLiySizeType_v = isLiySizeType<Ty>::value;
template <typename Ty>
inline constexpr bool isNullptr_v = isNullptr<Ty>::value;
template <typename Ty>
inline constexpr bool isPointer_v = isPointer<Ty>::value;
template <typename Ty>
inline constexpr bool isFundamental_v = isFundamental<Ty>::value;
template <typename Ty>
inline constexpr bool isCompound_v = isCompound<Ty>::value;
template <typename Ty>
inline constexpr bool isLvalueReference_v = isLvalueReference<Ty>::value;
template <typename Ty>
inline constexpr bool isRvalueReference_v = isRvalueReference<Ty>::value;
template <typename Ty>
inline constexpr bool isReference_v = isReference<Ty>::value;
template <typename Ty>
inline constexpr bool isArray_v = isArray<Ty>::value;
template <typename Ty>
inline constexpr bool isConst_v = isConst<Ty>::value;
template <typename Ty>
inline constexpr bool isVolatile_v = isVolatile<Ty>::value;
template <typename Ty>
inline constexpr bool isClass_v = isClass<Ty>::value;
template <typename Ty>
inline constexpr bool isEnum_v = isEnum<Ty>::value;
template <typename Ty>
inline constexpr bool isUnion_v = isUnion<Ty>::value;
template <typename Ty>
inline constexpr bool isFunction_v = isFunction<Ty>::value;
template <typename Ty>
inline constexpr bool isScalar_v = isScalar<Ty>::value;
template <typename Ty>
inline constexpr bool isMemberPointer_v = isMemberPointer<Ty>::value;
template <typename Ty, typename Up>
inline constexpr bool isBaseOf_v = isBaseOf<Ty, Up>::value;
template <typename Ty, typename Up>
inline constexpr bool isSame_v = isSame<Ty, Up>::value;
template <typename Ty, typename Up>
inline constexpr bool isSameIgnoreCV_v = isSameIgnoreCV<Ty, Up>::value;
