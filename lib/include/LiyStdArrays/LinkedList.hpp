...
namespace LiyStd {
    ...
    struct SinglyNode {
        ...
        /* 初始化 */
        SinglyNode() = default;
        SinglyNode(const T& data) : data(data) {}
        SinglyNode(const T& data, SinglyNode<T>* nPtr) : data(data), nextNode(nPtr) {}
    };
    ...
    struct DoublyNode {
        ...
        /* 初始化 */
        DoublyNode() = default;
        DoublyNode(const T& data) : data(data) {}
        DoublyNode(const T& data, DoublyNode<T>* nPtr, DoublyNode<T>* pPtr)
            : data(data), nextNode(nPtr), prevNode(pPtr) {}
    };
