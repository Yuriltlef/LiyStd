...
template <typename T>
bool SinglyListVirtual<T>::isEmpty() const {
    return length == 0;
}

template <typename T>
LiySizeType SinglyListVirtual<T>::size() const {
    return length;
}
...
template <typename T>
bool SinglyCircularListVirtual<T>::isEmpty() const {
    return length == 0;
}

template <typename T>
LiySizeType SinglyCircularListVirtual<T>::size() const {
    return length;
}
